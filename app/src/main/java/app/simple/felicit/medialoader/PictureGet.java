...
import app.simple.felicit.medialoader.mediaHolders.pictureContent;
import app.simple.felicit.medialoader.mediaHolders.pictureFolderContent;
...
public class PictureGet {
    ...
    public ArrayList<pictureContent> getAllPictureContents(Uri contentLocation) {
        ...
        cursor = pictureContext.getContentResolver().query(contentLocation, projection, null, null,
        ...
        try {
            ...
            do {
                ...
                try {
                    ...
                    ex.printStackTrace();
                    pictureContent.setDate_taken(0);
                }
    ...
    public ArrayList<pictureFolderContent> getPictureFolders() {
        ...
        @SuppressLint("InlinedApi") String[] projection = {
                ...
                MediaStore.Images.Media.DATE_ADDED};
        cursor = pictureContext.getContentResolver().query(externalContentUri, projection, null, null, "LOWER (" + MediaStore.Images.Media.DATE_TAKEN + ") DESC");
        try {
            cursor.moveToFirst();
            do {
    ...
    public ArrayList<pictureContent> getAllPictureContentByBucket_id(int bucket_id) {
        ...
        String[] projection = {MediaStore.Images.Media.DATA, MediaStore.Images.Media.DISPLAY_NAME, MediaStore.Images.Media.BUCKET_ID,
                ...
                MediaStore.Images.Media.DATE_MODIFIED};
        cursor = pictureContext.getContentResolver().query(externalContentUri, projection, MediaStore.Images.Media.BUCKET_ID + " like ? ", new String[]{"%" + bucket_id + "%"},
                "LOWER (" + MediaStore.Images.Media.DATE_TAKEN + ") DESC");
    ...
    public ArrayList<pictureFolderContent> getAbsolutePictureFolders() {
        ...
        @SuppressLint("InlinedApi") String[] projection = {
                ...
                MediaStore.Images.Media.DATE_MODIFIED};
        cursor = pictureContext.getContentResolver().query(externalContentUri, projection, null, null,
                "LOWER (" + MediaStore.Images.Media.DATE_TAKEN + ") DESC");
        try {
            cursor.moveToFirst();
            do {
