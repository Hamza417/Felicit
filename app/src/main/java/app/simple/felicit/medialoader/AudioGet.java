...
public class AudioGet {
    ...
    public ArrayList<AudioContent> getAllAudioContent(Uri contentLocation) {
        ...
        cursor = audioContext.getContentResolver().query(contentLocation, projection, selection, null, "LOWER (" + MediaStore.Audio.Media.TITLE + ") ASC");
        if (cursor != null) {
