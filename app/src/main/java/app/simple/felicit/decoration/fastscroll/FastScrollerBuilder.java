...
public class FastScrollerBuilder {
    ...
    public FastScrollerBuilder useDefaultStyle() {
        ...
        mTrackDrawable = AppCompatResources.getDrawable(context, R.drawable.ic_fast_scroller_track);
        mThumbDrawable = AppCompatResources.getDrawable(context, R.drawable.ic_fast_scroller_thumb);
