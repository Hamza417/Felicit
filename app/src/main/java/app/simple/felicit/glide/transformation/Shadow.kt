 ...
 */
class Shadow(private val context: Context) : BitmapTransformation() {
     ...
     * @return      returns self
     */
    fun setBlurRadius(blurRadius: Float): Shadow {
     ...
     * @return      returns self
     */
    fun setElevation(elevation: Float): Shadow {
     ...
     * @return      returns self
     */
    fun setAngle(angle: Float): Shadow {
        this.angle = angle
        return this
    }
     ...
     * @return returns self
     */
    fun setDirection(@Direction d: Int): Shadow {
        angle = getAngle(d)
        return this
    }
     ...
     * @return returns self
     */
    fun setShadowColour(@ColorInt colour: Int): Shadow {
        this.colour = colour
        return this
    }
     ...
     * @return      returns self
     */
    fun setShadowColourRes(@ColorRes res: Int): Shadow {
    ...
    companion object {
            private const val ID = "app.simple.felicit.glide.transformations.Shadow"
