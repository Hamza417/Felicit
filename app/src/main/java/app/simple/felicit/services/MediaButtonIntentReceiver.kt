    ...
    companion object {
        ...
        fun handleIntent(context: Context, intent: Intent): Boolean {
            ...
            if (Intent.ACTION_MEDIA_BUTTON == intentAction) {
                ...
                when (keycode) {
                    KeyEvent.KEYCODE_MEDIA_STOP -> command = actionStop
                    KeyEvent.KEYCODE_HEADSETHOOK, KeyEvent.KEYCODE_MEDIA_PLAY_PAUSE -> command = actionTogglePause
                    KeyEvent.KEYCODE_MEDIA_NEXT -> command = actionSkip
                    KeyEvent.KEYCODE_MEDIA_PREVIOUS -> command = actionRewind
                    KeyEvent.KEYCODE_MEDIA_PAUSE -> command = actionPause
                    KeyEvent.KEYCODE_MEDIA_PLAY -> command = actionPlay
                }
                if (command != null) {
